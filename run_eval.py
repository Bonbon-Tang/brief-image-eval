...
def main():
    ...
    quality_samples = run_quality_samples(base_url, config['model_id'], str(ROOT / 'configs' / 'prompts' / 'quality.jsonl'))
    ...
    judge_eval = run_judge_eval(
        ...
        quality_prompts_path=str(ROOT / 'configs' / 'prompts' / 'quality.jsonl'),
